...
include '../connect.php';
$urut = $_GET['urut'];
$query = "SELECT kode_mapel, mapel, alokasi_waktu, semester, kode_guru, nama_guru FROM t_mapel LEFT JOIN
          t_guru USING (kode_guru) ORDER BY $urut";
   ...
   <!-- SIDENAV -->
      ...
      <div id="main">
        ...
        <div class="box-login-title">
          ...
          <h3 id="myBtn" style="padding-left:50px;margin-top:-20px;cursor:pointer;font-size:23px;">Tambah Data</h3>
    </div>
     ...
     <div id="myModal" class="modal">
       ...
       <form  action="create.php" method="post">
         ...
         <input type="text" class="inputmodal" name="mapel" id="mapel" placeholder="Matapelajaran" required>
         ...
         <select class="inputmodal" name="kode_guru" id="kode_guru">
           <option value="-">Pilih Salah Satu Guru Pengajar</option>
